    ...
    class WOOPCD_PartialCOD_Admin_Method_Options_Restriction {
        ...
        public static function get_option( $in_options, $method_id ) {
            ...
            $in_options[ 'restriction' ] = array(
                'list_title' => esc_html__( 'Checkout - Restriction (Premium)', 'partial-cod-payment-gateway-restrictions-fees' ),
                'title' => esc_html__( 'Checkout - Restriction (Premium)', 'partial-cod-payment-gateway-restrictions-fees' ),
                'group_id' => 'checkout',
