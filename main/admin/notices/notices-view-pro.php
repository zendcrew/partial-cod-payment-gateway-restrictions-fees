<div class="notice notice-info woopcd-partialcod-notice is-dismissible" data-woopcd_partialcod_id="pro">
    ...
    <p>
        <a href="#" class="woopcd-partialcod-btn" target="_blank"><span class="dashicons dashicons-external"></span><?php esc_html_e( esc_html__( 'Yes! You deserve it', 'woopcd-partialcod' ) ); ?></a>
