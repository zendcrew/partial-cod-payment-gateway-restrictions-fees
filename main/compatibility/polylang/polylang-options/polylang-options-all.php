...
if ( !class_exists( 'WOOPCD_PartialCOD_Polylang_Method_Options_All' ) ) {

    class WOOPCD_PartialCOD_Polylang_Method_Options_All {
        ...
        public function translate_option( $option, $prefix ) {
            ...
            if ( isset( $option[ 'title' ] ) ) {
                ...
                $option[ 'title' ] = WOOPCD_PartialCOD_Polylang::get_translated_string( $option[ 'title' ], $title_string_id );
            }
            ...
            if ( isset( $option[ 'desc' ] ) ) {
                ...
                $option[ 'desc' ] = WOOPCD_PartialCOD_Polylang::get_translated_string( $option[ 'desc' ], $desc_string_id );
            }
            ...
            if ( isset( $option[ 'message' ] ) ) {
                ...
                $option[ 'message' ] = WOOPCD_PartialCOD_Polylang::get_translated_string( $option[ 'message' ], $message_string_id );
            }
