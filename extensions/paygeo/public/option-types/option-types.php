    ...
    class PGEO_PayGeo_Option_Types {
        ...
        public static function get_options($options, $options_args, $cart_data) {
            ...
            foreach ($options_args as $option_args) {
                ...
                $option = apply_filters('paygeo/get-' . $option_args['option_type'] . '-options', $option, $option_args, $cart_data);

                // allows other plugins to modify the option
                if (has_filter('paygeo/gotten-option')) {
                    $option = apply_filters('paygeo/gotten-option', $option, $option_args, $cart_data);
                }
