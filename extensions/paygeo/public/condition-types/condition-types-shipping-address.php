...
if ( !class_exists( 'PGEO_PayGeo_Conditions_Shipping_Address' ) ) {

    class PGEO_PayGeo_Conditions_Shipping_Address {

        public function __construct() {
            add_filter( 'paygeo/validate-shipping_countries-condition', array( $this, 'validate_countries' ), 10 );
            add_filter( 'paygeo/validate-shipping_states-condition', array( $this, 'validate_states' ), 10 );
            add_filter( 'paygeo/validate-shipping_cities-condition', array( $this, 'validate_cities' ), 10 );
            add_filter( 'paygeo/validate-shipping_postcodes-condition', array( $this, 'validate_postcodes' ), 10 );
        }
    ...
    new PGEO_PayGeo_Conditions_Shipping_Address();
}