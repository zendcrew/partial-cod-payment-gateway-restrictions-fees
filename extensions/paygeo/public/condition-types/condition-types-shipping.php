...
if ( !class_exists( 'PGEO_PayGeo_Conditions_Shipping' ) ) {

    class PGEO_PayGeo_Conditions_Shipping {

        public function __construct() {


            add_filter( 'paygeo/validate-shipping_needed-condition', array( $this, 'validate_needed' ), 10, 2 );
            add_filter( 'paygeo/validate-shipping_zones-condition', array( $this, 'validate_zones' ), 10, 2 );
            add_filter( 'paygeo/validate-shipping_methods-condition', array( $this, 'validate_methods' ), 10, 2 );
            add_filter( 'paygeo/validate-shipping_rates-condition', array( $this, 'validate_rates' ), 10, 2 );
        }
        ...
        public function validate_needed( $condition, $cart_data ) {
            ...
            return PGEO_PayGeo_Validation_Util::validate_yes_no( $needs_shipping, $rule_needs_shipping );
        }
        ...
        public function validate_zones( $condition, $cart_data ) {
            ...
            return PGEO_PayGeo_Validation_Util::validate_list_list( $zone_ids, $rule_shipping_zones, $rule_compare );
        }
        ...
        public function validate_methods( $condition, $cart_data ) {
            ...
            return PGEO_PayGeo_Validation_Util::validate_list_list( $method_ids, $rule_shipping_methods, $rule_compare );
        }
        ...
        public function validate_rates( $condition, $cart_data ) {
            ...
            return PGEO_PayGeo_Validation_Util::validate_list_list( $rate_ids, $rule_shipping_rates, $rule_compare );
        }
        ...
        private function get_zone_by_rates( $cart_rates ) {
            ...
            $sql_hash = 'paygeo_zones_query_' . md5( $instance_ids_sql );
        ...
        private function get_rate_ids( $cart_rates ) {
            ...
            if ( has_filter( 'paygeo/get-shipping-rate-ids' ) ) {

                $rate_ids = apply_filters( 'paygeo/get-shipping-rate-ids', $rate_ids, $cart_rates );
            }
    ...
    new PGEO_PayGeo_Conditions_Shipping();
}