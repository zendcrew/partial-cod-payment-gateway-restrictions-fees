...
if ( !class_exists( 'PGEO_PayGeo_Polylang_Cart_Discounts' ) ) {

    class PGEO_PayGeo_Polylang_Cart_Discounts {

        public function __construct() {

            add_filter( 'paygeo/discount-title', array( $this, 'tranlate_title' ), 10, 3 );
            add_filter( 'paygeo/discount-desc', array( $this, 'tranlate_desc' ), 10, 3 );

            add_filter( 'paygeo/discount-coupon-title', array( $this, 'tranlate_coupon_title' ), 10, 4 );
            add_filter( 'paygeo/discount-coupon-desc', array( $this, 'tranlate_coupon_desc' ), 10, 4 );
        }
        ...
        public function tranlate_title( $title, $discount_key, $discount ) {
            ...
            return PGEO_PayGeo_Polylang::get_translated_string( $title, $string_id );
        }
        ...
        public function tranlate_desc( $desc, $discount_key, $discount ) {
            ...
            return PGEO_PayGeo_Polylang::get_translated_string( $desc, $string_id );
        }
        ...
        private function get_prefix( $method_id, $rule_id ) {
            ...
            return 'pgeo_' . $method_id . '_cart_discounts_' . $rule_id . '_';
        }
