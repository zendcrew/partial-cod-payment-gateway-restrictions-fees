...
if ( !class_exists( 'PGEO_PayGeo_WPML_Method_Options_All' ) ) {

    class PGEO_PayGeo_WPML_Method_Options_All {
        ...
        public function translate_option( $option, $prefix ) {
            ...
            if ( isset( $option[ 'title' ] ) ) {
                ...
                $option[ 'title' ] = PGEO_PayGeo_WPML::get_translated_string( $option[ 'title' ], $title_string_id );
            }
            ...
            if ( isset( $option[ 'desc' ] ) ) {
                ...
                $option[ 'desc' ] = PGEO_PayGeo_WPML::get_translated_string( $option[ 'desc' ], $desc_string_id );
            }
            ...
            if ( isset( $option[ 'message' ] ) ) {
                ...
                $option[ 'message' ] = PGEO_PayGeo_WPML::get_translated_string( $option[ 'message' ], $message_string_id );
            }
