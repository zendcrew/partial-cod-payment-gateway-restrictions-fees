...
if ( !class_exists( 'PGEO_PayGeo_Admin_Method_Options_Checkout_All' ) ) {
    ...
    class PGEO_PayGeo_Admin_Method_Options_Checkout_All {
        ...
        public static function get_groups( $in_groups, $method_id ) {
            $in_groups[ 'checkout' ] = esc_html__( 'Checkout Settings', 'pgeo-paygeo' );
            return $in_groups;
        }
        ...
        public static function get_option( $in_options, $method_id ) {
            ...
            $in_options[ 'all' ] = array(
                'list_title' => esc_html__( 'Checkout - All Settings', 'pgeo-paygeo' ),
                'title' => esc_html__( 'Checkout - All Settings', 'pgeo-paygeo' ),
                'group_id' => 'checkout',
            );
            ...
            $in_fields[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'select2',
                        'column_size' => 1,
                        'column_title' => esc_html__( 'Restriction', 'pgeo-paygeo' ),
                        'tooltip' => esc_html__( 'Controls payment method availability on checkout page', 'pgeo-paygeo' ),
                        'default' => 'yes',
                        'options' => array(
                            'yes' => esc_html__( 'Is available', 'pgeo-paygeo' ),
                            'no' => esc_html__( 'Is restricted', 'pgeo-paygeo' ),
                        ),
                        'width' => '100%',
                        'fold_id' => 'all_enabled'
                    ),
                    ...
                    array(
                        ...
                        'show_box' => true,
                        'column_size' => 2,
                        'column_title' => esc_html__( 'Place Order Button Text', 'pgeo-paygeo' ),
            ...
            $in_fields[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'show_box' => true,
                        'column_size' => 1,
                        'column_title' => esc_html__( 'Icon Url', 'pgeo-paygeo' ),
            ...
            $in_fields[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'textarea',
                        'column_size' => 1,
                        'column_title' => esc_html__( 'Restriction Message', 'pgeo-paygeo' ),
                        'tooltip' => esc_html__( 'Controls payment method the restriction message on checkout page', 'pgeo-paygeo' ),
                        'default' => '',
