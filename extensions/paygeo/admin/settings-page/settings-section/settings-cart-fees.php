...
if ( !class_exists( 'PGEO_PayGeo_Admin_Fee_Rules_Cart_Totals' ) ) {
    ...
    class PGEO_PayGeo_Admin_Fee_Rules_Cart_Totals {
        ...
        public static function init() {
            ...
            add_filter( 'paygeo-admin/get-data-list-cartfees_carttotals', array( new self(), 'get_data_list' ), 10, 2 );
        }
        ...
        public static function get_data_list( $result, $data_args ) {
            ...
            $options = array();
            if ( isset( $pgeo_paygeo[ 'cart_fee_cart_totals' ] ) ) {
                $options = $pgeo_paygeo[ 'cart_fee_cart_totals' ];
            } else {
    ...
    PGEO_PayGeo_Admin_Fee_Rules_Cart_Totals::init();
}