...
if ( !class_exists( 'PGEO_PayGeo_Admin_Conditions_Shipping_Address' ) ) {
    ...
    class PGEO_PayGeo_Admin_Conditions_Shipping_Address {
        ...
        public static function get_groups( $in_groups, $args ) {
            ...
            $in_groups[ 'shipping_address' ] = esc_html__( 'Shipping Address', 'zcpg-woo-paygeo' );
        ...
        public static function get_conditions( $in_list, $args ) {
            ...
            if ( !defined( 'PGEO_PAYGEO_PREMIUM' ) ) {
                $in_list[ 'prem_4' ] = esc_html__( 'Shipping Continents (Premium)', 'zcpg-woo-paygeo' );
            } else {
                $in_list[ 'shipping_continents' ] = esc_html__( 'Shipping Continents', 'zcpg-woo-paygeo' );
            }
            
            $in_list[ 'shipping_countries' ] = esc_html__( 'Shipping Countries', 'zcpg-woo-paygeo' );
            $in_list[ 'shipping_states' ] = esc_html__( 'Shipping States', 'zcpg-woo-paygeo' );
            $in_list[ 'shipping_cities' ] = esc_html__( 'Shipping Cities', 'zcpg-woo-paygeo' );
            $in_list[ 'shipping_postcodes' ] = esc_html__( 'Shipping Postcode / ZIP', 'zcpg-woo-paygeo' );
        ...
        public static function get_countries_fields( $in_fields, $args ) {
            ...
            $in_fields[] = array(
                ...
                'placeholder' => esc_html__( 'Shipping Countries...', 'zcpg-woo-paygeo' ),
        ...
        public static function get_states_fields( $in_fields, $args ) {
            ...
            $in_fields[] = array(
                ...
                'minimum_input_length' => 2,
                'minimum_results_forsearch' => 10,
                'placeholder' => esc_html__( 'Shipping States...', 'zcpg-woo-paygeo' ),
                'ajax_data' => 'wc:states',
                'width' => '100%',
                'box_width' => '74%',
            );
