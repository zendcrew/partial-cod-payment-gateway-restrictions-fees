...
if ( !class_exists( 'PGEO_PayGeo_Admin_Notices' ) ) {

    class PGEO_PayGeo_Admin_Notices {
        ...
        private function __construct() {
            ...
            $this->notices_name = 'pgeo_paygeo_admin_notices1';

            add_action( 'admin_notices', array( $this, 'show_notice' ) );
            add_action( 'wp_ajax_pgeo_paygeo_dismiss_notice', array( $this, 'dismiss_notice' ) );
        }
        ...
        public function enqueue_scripts() {
            ...
            wp_enqueue_script( 'paygeo_notices_scripts_js', PGEO_PAYGEO_ASSETS_URL . 'admin-notices.js', array( 'jquery' ), '1.0', true );
        }
        ...
        private function is_pro_version() {
            ...
            if ( class_exists( 'PGEO_PayGeo_Premium' ) ) {
    ...
    PGEO_PayGeo_Admin_Notices::get_instance();
}
